            ...
            <ul class="topbar__nav--right nav">
              <li class="nav-item">
                <div class="position-relative h-100">
                  ...
                  <div
                    id="basicDropdownHover1"
                    class="dropdown-menu dropdown-unfold right-0 left-auto u-unfold--css-animation u-unfold--hidden fadeOut"
              ...
              <li className="nav-item d-flex flex-row align-items-center">
                ...
                <div className="account d-flex ">
                  <Link to="account/profile" className="d-flex flex-row align-items-center">  
