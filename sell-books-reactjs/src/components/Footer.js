            ...
            <div class="container py-5">
                <div class="row wrapper-footer-area">
                  ...
                  <div class="col-lg-2 col-6">
                    <h6 class="heading-xxs text-white">Explore</h6>
                  ...
                  <div class="col-lg-2 col-6">
                    <h6 class="heading-xxs text-white">Customer Service</h6>
                    <ul class="p-0 list-unstyled">
                      <li>
                        <a href="/" class="text-gray-450">
                         Help Center
                  ...
                  <div class="col-lg-2 col-6">
                    <h6 class="heading-xxs text-white">Policy</h6>
                    <ul class="p-0 list-unstyled">
                      <li>
                        <a href="/" class="text-gray-450">
                          Return Policy
                  ...
                  <div class="col-lg-2 col-6">
                    <h6 class="heading-xxs text-white">Categories</h6>
                    <ul class="p-0 list-unstyled">
                      <li>
                        <a href="/" class="text-gray-450">
                       Action
